...
QUnit.test("Tangens test",function(assert)
{
    ...
    assert.ok(isNaN(MathLib.TQtan(90)),"Exception - tan undefined for 90");
    assert.ok(isNaN(MathLib.TQtan(270)),"Exception - tan undefined for 270");
    assert.ok(isNaN(MathLib.TQtan(450)),"Exception - tan undefined for 450");
    assert.ok(isNaN(MathLib.TQtan(630)),"Exception - tan undefined for 630");
    assert.ok(isNaN(MathLib.TQtan(810)),"Exception - tan undefined for 810");
    assert.ok(isNaN(MathLib.TQtan(990)),"Exception - tan undefined for 990");
}
);
